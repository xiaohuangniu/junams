...
final class ImageUrlBuilder
{
    ...
    public function waterImg(
        ...
        $waterStr = 'watermark/1/image/' .\qiniu\Qiniu\base64_urlSafeEncode($image) . '/';
    ...
    public function waterText(
        ...
        $waterStr = 'watermark/2/text/'
            .\qiniu\Qiniu\base64_urlSafeEncode($text) . '/font/'
            .\qiniu\Qiniu\base64_urlSafeEncode($font) . '/';
        ...
        if (! is_null($fontColor)
            ...
            $waterStr .= 'fill/' .\qiniu\Qiniu\base64_urlSafeEncode($fontColor) . '/';
        }
