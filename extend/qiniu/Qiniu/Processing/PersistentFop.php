...
final class PersistentFop
{
    ...
    public function execute($key, $fops)
    {
       ...
       \qiniu\Qiniu\setWithoutEmpty($params, 'pipeline', $this->pipeline);
       \qiniu\Qiniu\setWithoutEmpty($params, 'notifyURL', $this->notify_url);
        if ($this->force) {
            $params['force'] = 1;
        }
