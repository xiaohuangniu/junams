...
<html>
    ...
    <body>
        ...
        <div class="system-message {$codeText}">
            <div class="image">
                <img src="__ADMIN__/images/{$codeText}.svg" alt="" width="150" />
            </div>
            <h1>{$msg}</h1>
            <p class="jump">
            ...
            <p class="clearfix">
                <a href="javascript:history.go(-1);" class="btn btn-grey">上一页</a>
                <a href="{$url}" class="btn btn-primary">立即跳转</a>
            </p>
        </div>
        <div class="copyright">
            <p>Powered by <a href="https://www.thinkmimi.com/p">ThinkMIMI</a></p>
        </div>
